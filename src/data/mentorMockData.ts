...
// ── Canadian Province Mentors (for Broker Hub CAN mode) ──

export const mockCanadianStateMentors: StateMentor[] = [
  {
    id: "csm1",
    name: "Éliane Tremblay",
    totalActiveMentees: 4,
    primaryEmail: "eliane.tremblay@exprealty.com",
    phone: "(514) 555-2847",
    ...
    locationsServiced: ["Montreal", "Laval", "Longueuil", "Brossard"],
    licenses: [{ state: "QC", number: "QC-441290" }],
    languages: ["French", "English"],
    mls: ["Centris"],
    specializations: ["Residential", "Condos", "First-Time Buyers"],
    certifications: ["ABR", "SRS"],
    facebook: "https://facebook.com/elianetremblay",
    linkedin: "https://linkedin.com/in/elianetremblay",
    menteeIds: ["m1", "m2", "m3", "m4"],
  },
  {
    id: "csm2",
    name: "James Whitfield",
    totalActiveMentees: 3,
    primaryEmail: "james.whitfield@exprealty.com",
    phone: "(416) 555-8103",
    ...
    locationsServiced: ["Toronto", "Mississauga", "Brampton", "Markham"],
    licenses: [{ state: "ON", number: "ON-882104" }],
    languages: ["English"],
    mls: ["TRREB MLS"],
    specializations: ["Residential", "Condos", "Investment Properties"],
    certifications: ["CRS", "ABR"],
    linkedin: "https://linkedin.com/in/jameswhitfield",
    website: "https://jameswhitfield.exprealty.com",
    menteeIds: ["m1", "m2", "m3"],
  },
  {
    id: "csm3",
    name: "Priya Sharma",
    totalActiveMentees: 2,
    primaryEmail: "priya.sharma@exprealty.com",
    phone: "(604) 555-6729",
    ...
    locationsServiced: ["Vancouver", "Burnaby", "Richmond", "Surrey"],
    licenses: [{ state: "BC", number: "BC-334510" }],
    languages: ["English", "Hindi", "Punjabi"],
    mls: ["GVR MLS"],
    specializations: ["Residential", "Luxury", "New Construction"],
    certifications: ["GRI", "SRS"],
    linkedin: "https://linkedin.com/in/priyasharmarealty",
    menteeIds: ["m1", "m2"],
  },
  {
    id: "csm4",
    name: "Marc-Antoine Bouchard",
    totalActiveMentees: 1,
    primaryEmail: "marc.bouchard@exprealty.com",
    phone: "(418) 555-3901",
    ...
    locationsServiced: ["Quebec City", "Lévis", "Beauport", "Sainte-Foy"],
    licenses: [{ state: "QC", number: "QC-229018" }],
    languages: ["French", "English"],
    mls: ["Centris"],
    specializations: ["Residential", "Heritage Properties", "Rural"],
    certifications: ["ABR"],
    website: "https://marcbouchard.exprealty.com",
    menteeIds: ["m1"],
  },
  {
    id: "csm5",
    name: "Anika Pedersen",
    totalActiveMentees: 3,
    primaryEmail: "anika.pedersen@exprealty.com",
    phone: "(403) 555-5214",
    ...
    locationsServiced: ["Calgary", "Airdrie", "Cochrane", "Okotoks"],
    licenses: [{ state: "AB", number: "AB-710394" }],
    languages: ["English"],
    mls: ["CREB MLS"],
    specializations: ["Residential", "Acreages", "Relocation"],
    certifications: ["CRS", "ABR", "e-PRO"],
    facebook: "https://facebook.com/anikapedersen",
    linkedin: "https://linkedin.com/in/anikapedersen",
    menteeIds: ["m1", "m2", "m3"],
  },
  {
    id: "csm6",
    name: "Daniel Fonseca",
    totalActiveMentees: 2,
    primaryEmail: "daniel.fonseca@exprealty.com",
    phone: "(613) 555-0482",
    ...
    locationsServiced: ["Ottawa", "Gatineau", "Kanata", "Orleans"],
    licenses: [{ state: "ON", number: "ON-550291" }],
    languages: ["English", "French", "Portuguese"],
    mls: ["OREB MLS"],
    specializations: ["Residential", "First-Time Buyers", "Relocation"],
    certifications: ["ABR", "SRS"],
    linkedin: "https://linkedin.com/in/danielfonseca",
    menteeIds: ["m1", "m2"],
  },
  {
    id: "csm7",
    name: "Rachel Kim-Nguyen",
    totalActiveMentees: 5,
    primaryEmail: "rachel.kimnguyen@exprealty.com",
    phone: "(905) 555-7318",
    ...
    locationsServiced: ["Hamilton", "Burlington", "Stoney Creek", "Ancaster"],
    licenses: [{ state: "ON", number: "ON-198450" }],
    ...
    facebook: "https://facebook.com/rachelkimnguyen",
    linkedin: "https://linkedin.com/in/rachelkimnguyen",
    website: "https://rachelkimnguyen.exprealty.com",
    menteeIds: ["m1", "m2", "m3", "m4", "m5"],
  },
  {
    id: "csm8",
    name: "Tyler MacLeod",
    totalActiveMentees: 1,
    primaryEmail: "tyler.macleod@exprealty.com",
    phone: "(780) 555-9204",
    ...
    locationsServiced: ["Edmonton", "St. Albert", "Sherwood Park", "Spruce Grove"],
    licenses: [{ state: "AB", number: "AB-443019" }],
    languages: ["English"],
    mls: ["REALTORS® Association of Edmonton MLS"],
    specializations: ["Residential", "New Construction", "Rural"],
    certifications: ["ABR"],
    linkedin: "https://linkedin.com/in/tylermacleod",
    menteeIds: ["m1"],
  },
];
