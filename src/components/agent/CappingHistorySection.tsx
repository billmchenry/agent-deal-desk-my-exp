...
const cappingHistoryData = [
  { startDate: "01/01/2026", endDate: "12/31/2026", capReached: "-", capPercentage: "50%" },
            ...
            <TableHeader>
              <TableRow className="bg-muted/50">
                {([
                  ...
                  <TableHead
                    key={key}
                    className={`font-semibold text-xs h-9 px-3 cursor-pointer select-none ${key === "capReached" ? "min-w-[110px]" : "min-w-[70px]"}`}
